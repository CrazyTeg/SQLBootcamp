-- 00 LetТs expand our data model to involve a new business feature.
...
-- if Уamount of ordersФ = 1 then УdiscountФ = 10.5  else if Уamount of ordersФ = 2 then 
-- УdiscountФ = 22 else  УdiscountФ = 30
...
-- The example of УproofФ is below
-- ...
...
-- 04 Please add the following constraint rules for existing columns of the person_discounts table.
...
-- LetТs apply this policy for the person_discounts table.
...
comment on table person_discounts is '“аблица дл€ персональных скидок клиентам';
comment on column person_discounts.id is '»ндификационный номер дл€ каждой из строк';
comment on column person_discounts.person_id is '»ндификационный номер дл€ клиента';
comment on column person_discounts.pizzeria_id is '»ндификационный номер дл€ пиццы';
comment on column person_discounts.discount is 'ѕерсональна€ скидка дл€ клиента';
